...
net = OptimizedLowRankRNN(4, hidden_size, 1, noise_std, alpha, rank=1, train_wi=True, train_wo=True)
train(net, x_train, y_train, mask_train, lr=lr_base / sqrt(hidden_size), n_epochs=50, keep_best=True, cuda=True,
      clip_gradient=1)
